pipeline {
    ...
    stages {
        stage("Clone Spring OAuth Social Login from Github") {
            steps {
                echo "Cloning Spring OAuth Social Login from Github. Please Wait..."
                git branch: 'main',
                    url: 'https://github.com/Elleined/spring-oauth-social-login'
                echo "Cloning Spring OAuth Social Login from Github. Success!"
            }
        }
        ...
        stage("Create Docker Image") {
            steps {
                ...
                sh 'docker build -t spring-oauth-social-login:latest .'
        ...
        stage("Push docker image to DockerHub") {
            steps {
                ...
                sh 'docker tag spring-oauth-social-login:latest elleined/spring-oauth-social-login:latest'
                sh 'docker push elleined/spring-oauth-social-login:latest'
